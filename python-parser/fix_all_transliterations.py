#!/usr/bin/env python3
"""
Скрипт для исправления всех обрезанных транслитераций в Бхагавад-гите
"""
...
class TransliterationFixer:
    ...
    def extract_transliteration_from_html(self, html: str, verse_number: int) -> str:
        ...
        transliteration_patterns = [
            # Pattern for verses starting with common words
...
async def main():
    print("🚀 Запуск исправления транслитераций...")
    
    async with TransliterationFixer() as fixer:
